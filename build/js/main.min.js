...
var _tours = require("./modules/tours/tours");
var _education = require("./modules/education/education");
var _reviews = require("./modules/reviews/reviews");
var _advantages = require("./modules/advantages/advantages");
var _photogallery = require("./modules/photogallery/photogallery");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _tours.createTourSlider)();
    (0, _education.createEducationSlider)();
    (0, _reviews.createReviewsSlider)();
    (0, _advantages.createAdvantagesSlider)();
    (0, _photogallery.createPhotogallerySlider)();
...
},{"./modules/advantages/advantages":2,"./modules/education/education":3,"./modules/form-validate/form":5,"./modules/header/toggle":11,"./modules/hero/audioplayer":12,"./modules/hero/hero-slider":13,"./modules/hero/videoplayer":14,"./modules/leaflet/leaflet":15,"./modules/modals/init-modals":16,"./modules/photogallery/photogallery":18,"./modules/reviews/reviews":19,"./modules/tours/tours":20,"./utils/ios-vh-fix":23}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.handleResize = exports.createAdvantagesSlider = void 0;
...
var buttonNext = document.querySelector('.advantages__swiper-next');
var buttonPrev = document.querySelector('.advantages__swiper-prev');
var mySwiper;
var createAdvantagesSlider = function createAdvantagesSlider() {
  if (sliderAdvantages && innerWidth > 1199) {
    mySwiper = new _swiper.default(sliderAdvantages, {
      loop: true,
      slidesPerView: 3,
      spaceBetween: 30,
      allowTouchMove: true,
...
exports.createAdvantagesSlider = createAdvantagesSlider;
...
},{"../../vendor/swiper":26}],3:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.createEducationSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var createEducationSlider = function createEducationSlider() {
  var swiper = new _swiper.default('.swiper-education', {
    navigation: {
...
exports.createEducationSlider = createEducationSlider;

},{"../../vendor/swiper":26}],4:[function(require,module,exports){
"use strict";
...
var container = document.querySelector('.hero__audio-wrapper');
var link = document.querySelector('.hero__audio-link');
var button = document.querySelector('.hero__audio-button');
var cover = document.querySelector('.hero__audio').querySelector('picture');
var showAudioButton = function showAudioButton() {
  button.style.display = 'block';
};
exports.showAudioButton = showAudioButton;
var showAudioCover = function showAudioCover() {
  cover.style.display = 'block';
};
exports.showAudioCover = showAudioCover;
var createAudio = function createAudio(element) {
...
var initSwiperHero = function initSwiperHero() {
  var swiper = new _swiper.default('.swiper-hero', {
    speed: 500,
    loop: false,
    pagination: {
      el: '.hero__pagination',
...
exports.initSwiperHero = initSwiperHero;

},{"../../vendor/swiper":26,"./audioplayer":12,"./videoplayer":14}],14:[function(require,module,exports){
"use strict";
...
var createVideo = function createVideo(element) {
  if (document.querySelector('.video__wrapper iframe')) {
    document.querySelector('.video__wrapper iframe').remove();
  }
  var iframe = document.createElement('iframe');
...
var initLeaflet = function initLeaflet() {
  ...
  _leaflet.default.marker([55.774906445034176, 37.632641498705205], {
    icon: myIcon
  }).addTo(map);
};
exports.initLeaflet = initLeaflet;

},{"../../vendor/leaflet":25}],16:[function(require,module,exports){
"use strict";
...
exports.createPhotogallerySlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var createPhotogallerySlider = function createPhotogallerySlider() {
  var swiper = new _swiper.default('.swiper-photogallery', {
    slidesPerView: 'auto',
    navigation: {
...
exports.createPhotogallerySlider = createPhotogallerySlider;
...
var createReviewsSlider = function createReviewsSlider() {
  var swiper = new _swiper.default('.swiper-reviews', {
    slidesPerView: 1,
    allowTouchMove: true,
    navigation: {
...
exports.createTourSlider = void 0;
var _swiper = _interopRequireDefault(require("../../vendor/swiper"));
function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
var createTourSlider = function createTourSlider() {
  var swiper = new _swiper.default('.swiper-tours', {
    navigation: {
...
exports.createTourSlider = createTourSlider;
